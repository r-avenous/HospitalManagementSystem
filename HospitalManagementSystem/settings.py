...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'hospital_admin@gmail.com' # this email will be used to send emails
EMAIL_HOST_PASSWORD = 'admin123' # host email password required
